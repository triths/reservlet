...
public class UpdatePersonJSP extends HttpServlet{
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<hr/>");
		out.println("<form action='/reservlet/index/UpdatePerson' method='post'>");
		out.println("<input type='text' name='id' value='"+u.getId()+"' style='display:none'>");
		out.println("<table align='center'>");
		
		out.println("<tr>");
		out.println("<td>姓名</td>");
		out.println("<td><input type='text' name='name' value='"+u.getName()+"'></td>");
		out.println("</tr>");
		
		out.println("<tr>");
		out.println("<td>手机</td>");
		out.println("<td><input type='text' name='mobile' value='"+u.getMobile()+"'></td>");
		out.println("</tr>");
		
		out.println("<tr>");
		out.println("<td>固话</td>");
		out.println("<td><input type='text' name='telphone' value='"+u.getTelphone()+"'></td>");
		out.println("</tr>");
		
		out.println("<tr>");
		out.println("<td>邮箱</td>");
		out.println("<td><input type='text' name='email' value='"+u.getEmail()+"'></td>");
		out.println("</tr>");
		
		out.println("<tr>");
		out.println("<td>城市</td>");
		out.println("<td><input type='text' name='city' value='"+u.getCity()+"'></td>");
		out.println("</tr>");
		
		out.println("<tr>");
		out.println("<td>生日</td>");
		out.println("<td><input type='text' name='birthday' value='"+u.getBirthday()+"'></td>");
		out.println("</tr>");
